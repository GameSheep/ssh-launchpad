...
function Workspace() {
  const { servers, apps, runtime, loading, error, pendingFingerprint, createServer, createApp, updateApp, clearError, confirmPendingFingerprint, rejectPendingFingerprint } = useLaunchpad()
