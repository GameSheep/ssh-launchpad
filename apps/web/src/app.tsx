...
import { AgentSetup, ControlLogin } from './components/control-gate.js'

function Workspace() {
  const { servers, apps, runtime, loading, error, pendingFingerprint, fingerprintBusy, createServer, createApp, updateApp, clearError, confirmPendingFingerprint, rejectPendingFingerprint } = useLaunchpad()
...
function ControlGate() {
  ...
  if (agentOffline) return <AgentSetup />
  return <Workspace />
}
