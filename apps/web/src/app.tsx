...
function Workspace() {
  ...
  const saveServer = async (input: ServerInput, credential?: { kind: 'password' | 'private-key-passphrase'; value: string }) => { const saved = await createServer(input); if (credential) browserCredentials.set(saved.id, credential) }
